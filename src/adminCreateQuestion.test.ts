...
describe('Error Cases', () => {
  test('Question string less than or greater than 50 characters', () => {
    ...
    let res = request('POST', SERVER_URL + `/v2/admin/quiz/${quiz1.quizId}/question`, body);
    ...
    res = request('POST', SERVER_URL + `/v2/admin/quiz/${quiz1.quizId}/question`, body);
    expect(JSON.parse(res.body.toString())).toStrictEqual({ error: expect.any(String) });
    expect(res.statusCode).toStrictEqual(400);
  });
  ...
  test('Question duration is not positive', () => {
    ...
    const res = request('POST', SERVER_URL + `/v2/admin/quiz/${quiz1.quizId}/question`, body);
    expect(JSON.parse(res.body.toString())).toStrictEqual({ error: expect.any(String) });
    expect(res.statusCode).toStrictEqual(400);
  });
  ...
  test('Quiz not owned by user', () => {
    ...
    const quizRes = request('POST', SERVER_URL + '/v2/admin/quiz', { json: { token: user2.token, name: 'a different quiz', description: 'okay' } });
    ...
    res = request('POST', SERVER_URL + `/v2/admin/quiz/${quiz2.quizId}/question`, body);
    expect(JSON.parse(res.body.toString())).toStrictEqual({ error: expect.any(String) });
...
describe(' Successful Cases', () => {
  test('Successfully adds question for user', () => {
    ...
    expect(res.statusCode).toStrictEqual(200);
    res = request('POST', SERVER_URL + `/v2/admin/quiz/${quiz1.quizId}/question`, body1);
