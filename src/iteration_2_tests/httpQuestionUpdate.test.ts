...
describe('Error Cases', () => {
  test('Question string less than or greater than 50 characters', () => {
    ...
    let res = request('PUT', SERVER_URL + `/v1/admin/quiz/${quiz1.quizId}/question/${question.questionId}`, body);
    ...
    res = request('PUT', SERVER_URL + `/v1/admin/quiz/${quiz1.quizId}/question/${question.questionId}`, body);
  ...
  test('Question duration is not positive', () => {
    ...
    const res = request('PUT', SERVER_URL + `/v1/admin/quiz/${quiz1.quizId}/question/${question.questionId}`, body);
  ...
  test('Quiz not owned by user', () => {
    ...
    res = request('PUT', SERVER_URL + `/v1/admin/quiz/${quiz2.quizId}/question/${question.questionId}`, body);
